...
void main(void) {
    ...
    while(1){
        ...
        if (PORTBbits.RB0) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB0 && PORTD == 0b0001000) {
                while(PORTBbits.RB0);
                PORTD = 0b0000100;
            }
        }

        if (PORTBbits.RB0 && PORTD == 0b0000100) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB0) {
                while(PORTBbits.RB0);
                PORTD = 0b0000010;
        ...
        if (PORTBbits.RB0 && PORTD == 0b0000010) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB0) {
                while(PORTBbits.RB0);
                PORTD = 0b0000001;
        ...
        if (PORTBbits.RB1) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB1 && PORTD == 0b0001000) {
                while(PORTBbits.RB1);
                PORTD = 0b0010000;
            }
        }

        if (PORTBbits.RB1 && PORTD == 0b0010000) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB1) {
                while(PORTBbits.RB1);
                PORTD = 0b0100000;
        ...
        if (PORTBbits.RB1 && PORTD == 0b0100000) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB1) {
                while(PORTBbits.RB1);
                PORTD = 0b1000000;
        ...
        if (PORTBbits.RB0) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB0 && PORTD == 0b0010000) {
                while(PORTBbits.RB0);
                PORTD = 0b0001000;
            }
        }
        ...
        if (PORTBbits.RB1) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB1 && PORTD == 0b0000100) {
                while(PORTBbits.RB1);
                PORTD = 0b0001000;
            }
        }
        ...
        if (PORTBbits.RB0) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB0 && PORTD == 0b0100000) {
                while(PORTBbits.RB0);
                PORTD = 0b0010000;
            }
        }
        ...
        if (PORTBbits.RB1) {
            _delay((unsigned long)((50)*(20000000/4000000.0)));
            if (PORTBbits.RB1 && PORTD == 0b0000010) {
                while(PORTBbits.RB1);
                PORTD = 0b0000100;
            }
        }
